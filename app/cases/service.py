...
# --- SMART EXTRACTOR (EXTRAÇÃO INTELIGENTE) ---
    ...
    try:
        with pdfplumber.open(temp_filename) as pdf:
            for page in pdf.pages:
                # LÊ LINHA POR LINHA PARA PEGAR O NOME AO LADO DO CPF
                ...
                for line in lines:
                    ...
                    if cpf_match:
                        ...
                        # Remove o CPF da linha para tentar achar o nome
                        possible_name = re.sub(r'(CPF|Nome|:|;|-|\.|[\d])', '', line.replace(cpf_val, "")).strip()
                        
                        # Se sobrar texto, assumimos que é o nome
